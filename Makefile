SERVICE = aaronjberlinercontigfilter
SERVICE_CAPS = aaronjberlinerContigFilter
SPEC_FILE = aaronjberlinerContigFilter.spec
URL = https://kbase.us/services/aaronjberlinercontigfilter
DIR = $(shell pwd)
LIB_DIR = lib
SCRIPTS_DIR = scripts
TEST_DIR = test
